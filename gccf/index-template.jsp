...
<!-- clf2-nsi2 theme ends / Fin du thème clf2-nsi2 -->
	...
	<script  language="JavaScript" type="text/javascript">			
		        ...
		        function switch_to_fra() {
		        	...
		        	$("#cn-banner-text").html("Simulateur de service fournisseur de justificatifs");
	                ...
	                $("#cn-centre-col-inner").html(
		                	...
		                	+ "<!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->"
		                	+ "<p>"
		                	+ "Si vous voyez cette page, c'est que vous avez démarré avec succès, le simulator de "
		                	+ "service fournisseur de justificatifs. "
		                	+ "</p>"
		                	+ "<section>"
		                	+ "<header>"
		                	...
		                	+ "<header>"
		                	+ "<p>"
		                	+ "Vous pouvez téléchargé les métadonnée du simulator de service fournisseur de justificatifs en utilisant <a href=\"cats2-signed.xml\">le lien suivant</a>."
		                	+ "</p>"
		                	+ "<p>"
		                	+ "Vous pouvez téléchager le certificate SSL auto-signé en format "
		                	...
		                	+ "<header>"
		                	+ "<p>"
		                	+ "Utilisez le menu de gauche pour accéder aux consoles d'administration Tomcat et OpenAM. Les justificatifs à défaut sont les suivants:"
		                	+ "</p>"
		                	+ "<table class=\"results\">"
	                ...
	                $("#cn-in-pd").html(
		                	...
		                	+ "<dd><span><time>2015-11-06</time></span></dd>"
		                	+ "</dl>"
		                	+ "<div id=\"cn-toppage-foot\">"
		                	+ "<a href=\"#cn-tphp\" title=\"Return to Top of Page\">Haut de la page</a>"
		                	+ "</div>"
		                	+ "<div id=\"cn-in-pd-links\">"
		                	+ "<ul>"
		                	+ "<li id=\"cn-inotices-link\">"
		                	+ "<a href=\"#\" rel=\"license\">Avis importants</a></li>"
		                	+ "</ul>"
		                	+ "</div>"
		                );
				}
		        ...
		        function switch_to_eng() {
	                ...
	                $("#cn-in-pd").html(
		                	...
		                	+ "<ul>"
		                	+ "<li id=\"cn-inotices-link\">"
		                	+ "<a href=\"#\" rel=\"license\">Important Notices</a></li>"
		                	+ "</ul>"
		                	+ "</div>"
		                );
		        }
