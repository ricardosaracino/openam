...
<%@ page import="com.sun.identity.sm.SmsWrapperObject"%>
...
%>
        ...
        <td>
<%
        Properties tprop = (prop != null)? prop : propDef;
        out.println(ESAPI.encoder().encodeForHTML(tprop.getProperty("com.iplanet.am.server.protocol").trim() + "://" +
            tprop.getProperty("com.iplanet.am.server.host").trim() + ":" +
            tprop.getProperty("com.iplanet.am.server.port").trim() +
            tprop.getProperty("com.iplanet.am.services.deploymentDescriptor")));
        if (prop == null) {
           out.println(" <b>(Host configuration not found)</b>");
        }
%>
        </td>
        </tr>
...
%>
        ...
        <td>
<%
        out.println("<B>File Based Configuration</B>");
%>
        </td>
        <td>
<%
        out.println(Boolean.toString(SmsWrapperObject.isFileBasedConfigEnabled()));
%>
        </td>
        </tr>
...
<%
        String strConfigDir;
        if (prop != null) {
            strConfigDir = prop.getProperty("com.iplanet.services.configpath");
            ...
            strConfigDir = propDef.getProperty("com.iplanet.services.configpath");
            out.println("-");
        }
%>
        </td>
